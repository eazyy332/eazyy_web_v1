...
import { Search, Plus, Minus, ArrowLeft, ArrowRight, ShoppingBag, Info, Tag, Check, Star } from 'lucide-react';
...
const BaseItemSelection: React.FC<BaseItemSelectionProps> = ({
  ...
  const searchFilteredItems = filteredItems.filter(item => {
    ...
    const matchesSearch = 
      ...
      (hasDescription && description.toLowerCase().includes(searchTerm.toLowerCase()));
                    ...
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        {item.is_popular && (
                          <div 
                            style={getLightBackgroundStyle(serviceColorHex)}
                            className="ml-2 px-2 py-1 text-xs font-medium rounded-full flex items-center"
                          >
